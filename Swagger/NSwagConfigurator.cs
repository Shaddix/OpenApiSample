...
namespace OpenApiSample.Swagger
{
    public class NSwagConfigurator
    {
        public NSwagConfigurator(IConfiguration configuration)
        {
            ...
            SwaggerOptions.Endpoint.Url = $"/nswag{SwaggerOptions.Endpoint.Url}";
            SwaggerOptions.Endpoint.UiUrl = $"/nswag{SwaggerOptions.Endpoint.UiUrl}";
        }
                        ...
                        Flows = new NSwag.OpenApiOAuthFlows()
                        {
                            Password = new NSwag.OpenApiOAuthFlow()
                            {
                                ...
                                Scopes = new Dictionary<string, string>()
                                {
                                    ...
                                    {"OpenApiSampleAPI", "OpenApiSampleAPI"},
                                }
                            }
                        }
                    });
